 ...
 * 文件名:ZedObservable
 * 创建者:zed
 * 创建日期:2019/4/17 10:30
 * 描述:TODO
 */
public class ZedObservable<T> extends Observable<T> {
    ...
    public ZedObservable(Call<T> originalCall, boolean isAsync) {
    ...
    public ZedObservable(Call<T> originalCall, int maxRetries, int retryDelayMillis) {
        this.originalCall = originalCall;
